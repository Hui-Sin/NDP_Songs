...
public class ModifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getTitle().toString() + " ~ " + getResources().getText(R.string.title_activity_modify));
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(ModifyActivity.this, "Invalid year", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (result > 0) {
                    Toast.makeText(ModifyActivity.this, "Song updated", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(ModifyActivity.this, "Update failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result > 0) {
                    Toast.makeText(ModifyActivity.this, "Song deleted", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(ModifyActivity.this, "Delete failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
